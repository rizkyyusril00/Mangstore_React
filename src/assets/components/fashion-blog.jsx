                        ...
                        <div className="fashion-box">
                            ...
                            <div className="hidden md:inline">
                                ...
                                <div className="flex justify-between mt-3">
                                    ...
                                    {/* button */}
                                    <div className="box">
                                        <p><a href="/detail-blog" className="px-[16px] py-[8px] border-t-[1px] border-l-[1px] border-r-[3px] border-b-[3px] border-black bg-secondary">View more <i className="bi bi-arrow-right"></i></a></p>
                                    </div>
                                </div>
                                {/* konten */}
                                <div>
