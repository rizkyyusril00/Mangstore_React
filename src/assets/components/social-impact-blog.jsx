                        ...
                        <div className="fashion-box">
                            ...
                            <div className="inline md:hidden">
                                <div className="flex justify-between mt-2">
                                    <h1 data-aos="fade-right" className="text-[14px] font-bold text-primary">Social Impact</h1>
                                    <Link to='/detail-blog'><i className="bi bi-arrow-right text-primary"></i></Link>
                                </div>
                                {/* big img */}
                                <div className="w-full h-[210px] bg-red-50 mt-1 relative">
                                    <img src={Produk13} alt="" className="w-full h-full" />
                                ...
                                <div className="box flex gap-2 mb-2 mt-2">
                                    <div className="w-[154px] h-full">
                                        <img src={Produk14} alt="" className="w-full h-full" />
                                    </div>
                            ...
                            <div className="hidden md:inline">
                                ...
                                <div className="flex justify-between mt-3">
                                    <h1 data-aos="fade-right" className="text-[24px] font-bold text-primary">Social Impact</h1>
                                    {/* button */}
                                    <div className="box">
                                        <p className=""><a href="/detail-blog" className="px-[16px] py-[8px] border-t-[1px] border-l-[1px] border-r-[3px] border-b-[3px] border-black bg-secondary">View more <i className="bi bi-arrow-right"></i></a></p>
                                    </div>
                                </div>
                                {/* konten */}
                                <div>
                                    <div className='h-[380px] flex gap-2'>
                                        <div className='box w-1/2 relative'>
                                            <img src={Produk13} alt="" className="h-full w-full" />
                                        ...
                                        <div className="box w-1/2">
                                            <div className='flex flex-col gap-2 overflow-hidden h-[380px]'>
                                                ...
                                                <div className="flex h-1/2 gap-2">
                                                    <img src={Produk13} alt="" className="h-full w-1/2" />
